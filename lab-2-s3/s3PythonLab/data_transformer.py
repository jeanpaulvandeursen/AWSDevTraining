...
INPUT_BUCKET_NAME = "jpwashereinput"
OUTPUT_BUCKET_NAME = "jpwashereoutput"
...
class DataTransformer:
    ...
    def generate_presigned_url(self, bucketname, key):
        ...
        """
        s3 = self.s3
        url = s3.meta.client.generate_presigned_url('get_object', Params={'Bucket': bucketname, 'Key': key}, ExpiresIn=900)
